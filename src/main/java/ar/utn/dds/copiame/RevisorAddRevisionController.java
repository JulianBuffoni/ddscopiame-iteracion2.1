...
public class RevisorAddRevisionController implements Handler {
	private AnalsisRepository repo;

	public RevisorAddRevisionController(AnalsisRepository repo) {
		this.repo = repo;
	}

	@Override
	public void handle(Context ctx) throws Exception { // TODO
